        ...
        <div className="flex items-center">
          ...
          <div className="ms-3">
            <h3 className="font-semibold text-gray-800 dark:text-white">
              ...
              <span className="text-sm my-auto ml-1 font-light bg-gray-200 py-1 px-2 rounded-full">{user?.user_metadata?.role === 'user' ? 'Citizen' : user?.user_metadata?.role === 'officer' ? 'Ward Member (worker)' : 'Municipal Officer'}</span>
